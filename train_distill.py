...
def parse_args():
    ...
    '''eval'''
    parser.add_argument('--saveEpoch',type=int, default=100, help='unit: epoch')
    parser.add_argument('--diagEpoch', type=int, default=100, help='unit: epoch')
    parser.add_argument('--vizEpoch', type=int, default=100, help='unit: epoch')
    parser.add_argument('--printFreqIter', type=int, default=10, help='unit: iter')
